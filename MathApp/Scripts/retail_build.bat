...
REM  build 
call %msBuildDir%\msbuild.exe %DF_MSBUILD_BUILD_STATS_OPTS% MathApp.sln  /t:Build /p:Configuration=Release
...
xcopy /s .\dotNet\MathApp\bin\Release\MathApp.exe .\output\installers\MathApp\
